...
insert into CLUB(name, category, detail_category, intro, content, representative_picture)
values ('DCON326', '스터디', '공부', '같이 코딩공부해요~', 'NULL NULL 팀 LINCO 스터디 클럽입니다.', '지능모자라.png');
...
# insert into BOARD(user_id, club_id, board_type_id, title, content, viewcnt)
# values (1, 1, 4, '클럽공지', '월, 수 본인 자리에 남아서 10시까지 공부하시면 됩니다. 화, 목, 금 6시 이후 뒤에 수업이 있으니 자습실로 모여주세요~', 1),
#        (1, null, 1, '공지사항', 'NULL NULL팀 게시판 공지사항 입니다.', 1);
...
insert into RESERVATION (user_id, reservation_name, email, merchantUid, impUid, tel, venue_id, venue_name, status,
                         reserve_date, reserve_start_time, reserve_end_time, total_price)
values (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987765533', 'imp_986822555831', '010-0000-0000', 1,
        '서울역사박물관 야주개홀(강당) (24. 5월)', 'PAYED', '2024-06-28', '14:00:00', '18:00:00', 4000),
       (2, '김세현', 'yee0514@gamil.com', 'merchant_1658987765535', 'imp_986822555834', '010-1234-1234', 1,
        '서울역사박물관 야주개홀(강당) (24. 5월)', 'CANCELED', '2024-06-28', '09:00:00', '11:00:00', 2000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987765538', 'imp_986822555861', '010-0000-0000', 1,
        '서울역사박물관 야주개홀(강당) (24. 5월)', 'CANCELED', '2024-06-29', '09:00:00', '11:00:00', 2000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987765553', 'imp_986822555835', '010-0000-0000', 1,
        '서울역사박물관 야주개홀(강당) (24. 5월)', 'CANCELED', '2024-07-12', '09:00:00', '18:00:00', 9000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987769553', 'imp_986822555833', '010-0000-0000', 1,
        '서울역사박물관 야주개홀(강당) (24. 5월)', 'CANCELED', '2024-07-15', '09:00:00', '18:00:00', 9000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987765554', 'imp_986822455831', '010-0000-0000', 2,
        '서울역사박물관 야주개홀(강당) (24. 6월)', 'CANCELED', '2024-07-12', '09:00:00', '18:00:00', 9000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987765573', 'imp_986842555831', '010-0000-0000', 2,
        '서울역사박물관 야주개홀(강당) (24. 6월)', 'PAYED', '2024-07-05', '09:00:00', '10:00:00', 1000),
       (1, '김예현', 'yee0514@gamil.com', 'merchant_1658987766553', 'imp_986822255831', '010-0000-0000', 2,
        '서울역사박물관 야주개홀(강당) (24. 6월)', 'CANCELED', '2024-07-05', '11:00:00', '12:00:00', 1000),
       (6, '신우섭', 'sws0319@naver.com', 'merchant_1658987766555', 'imp_986822255833', '123-1234-1234', 10,
        '2024년 한강 코딩드론교실', 'PAYED', '2024-07-01', '11:00:00', '12:00:00', 1000)
;
