...
values ('부리부리부리부리', '운동', '축구', '어서왕~~~~', '부리부리부리부리 축구하쟝', 'upload/face03.png'),
       ('디컨', '스터디', '컴퓨터', '하기 시러', '집에 가고 싶어, 자고 싶어', 'upload/face04.png'),
       ('공부할 사람2', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람1', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람3', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람4', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람5', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람6', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람7', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람8', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람9', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('공부할 사람10', '스터디', '컴퓨터', '하고 싶지 않아', '집 언제 가?', 'upload/face01.png'),
       ('영화볼 사람', '문화예술', '여가', '인사이드아웃2', '인사이드아웃2 볼거야', 'upload/face02.png'),
       ('군산 갈 사람', '여행', '여행', '군산여행', '군산여행', 'upload/face03.png')
       ;
